...
import uk.gov.hmcts.cmc.claimstore.services.stateflow.grammar.*;
 ...
 * - evaluate the current state of a Claim
...
public class StateFlowBuilder<S> {
    ...
    protected class Grammar<S>
        ...
        @Override
        public OnlyIfNext<S> onlyIf(Predicate<Claim> condition) {
