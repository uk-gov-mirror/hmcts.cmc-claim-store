package uk.gov.hmcts.cmc.claimstore.services.stateflow.utils;
...
public class StateMachineUtilsTest {
    ...
    @Test
    public void shouldFindPermittedTransitionsForStateThatHasNoTransitions() {
    ...
    @Test
    public void shouldFindPermittedTransitionsForStateThatHasGuardedTransitionsButNoneArePermitted() {
    ...
    @Test
    public void shouldFindPermittedTransitionsForStateThatHasGuardedTransitionsThatArePermitted() {
    ...
    @Test
    public void shouldFindPermittedTransitionsForStateThatHasImplicitTransitions() {
